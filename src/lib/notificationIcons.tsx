 ...
 * Maps icon keys from backend to SVG components
 */
...
export function getNotificationIcon(iconKey?: string): JSX.Element {
  return NOTIF_ICONS[iconKey || 'bell'] ?? NOTIF_ICONS.bell;
}
